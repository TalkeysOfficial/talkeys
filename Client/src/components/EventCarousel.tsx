        ...
        >
          ...
          >
            <div className="relative w-full h-full flex flex-col">
              {/* event image */}
              <CardItem translateZ={40} className="relative w-full aspect-square overflow-hidden">
                <Image
              ...
              {/* event content */}
              <CardItem translateZ={30} className="p-2 sm:p-4 flex flex-col flex-grow">
                ...
                <div className="text-xs sm:text-sm text-gray-400 mb-3 sm:mb-6 flex gap-1 sm:gap-2 items-center">
                  ...
                  <div className="hidden sm:block">{formatTime(event.startTime)}</div>
                </div>
...
const EventCarousel: React.FC<EventCarouselProps> = ({ category = "ALL Events", ev = [] }) => {
